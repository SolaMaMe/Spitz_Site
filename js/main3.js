...
wrapper.forEach(element => {
  ...
  element.addEventListener("mousemove", ele => {
    ...
    const cardBg3 = card.querySelector(".cardBg3");
    ...
    cardBg3.style.transform = `translateX(${posX}px) translateY(${posY}px)`;
  });
  ...
  element.addEventListener("mouseout", () => {
    ...
    cardBg3.style.transform = `translateX(0px) translateY(0px)`;
  });
});